<template>
	...
	>
		<div class="custom-shape-divider-top-1626805149">
			...
			>
				...
				>
					...
					>
						...
						/>
						<v-card-title>Just click, add and get your order</v-card-title>
					</v-card>
				</v-col>
				<v-col cols="12"
					xl="4"
				...
				>
					...
					>
						...
						/>
						<v-card-title>
							Pay your order at your doorstep
						</v-card-title>
					</v-card>
				</v-col>
				<v-col cols="12"
				...
				>
					...
					>
						<v-img
							...
							height="140"
						/>
						<v-card-title>Secure online payment system</v-card-title>
					</v-card>
				</v-col>
			</v-row>
		</v-card>
...
<style>
.custom-shape-divider-top-1626805149 {
	position: absolute;
	top: 0;
	left: 0;
	width: 100%;
...
.custom-shape-divider-top-1626805149 svg {
	position: relative;
	display: block;
...
.custom-shape-divider-top-1626805149 .shape-fill {
	fill: #e5e5e5;
}
</style>
